...
public class ComponenteBD implements java.io.Serializable{
    ...
    public ArrayList<Object> readAllColection(String colecion){
        return mongo.readAll(colecion);
    }
    ...
    public boolean update(String campoID, String id, String campo, String update){
        return mongo.update(campoID, id, campo, update);
    }
    ...
    public boolean insert(Object object){
         switch (modelo) {
            ...
            case MONGO: return mongo.insert(object);
            default: return false;
        }
    }
    ...
    public boolean delete(String field, String value){
        return mongo.delete(field, value);
    }
